  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto py-8 px-4 space-y-6">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <!-- PayPal Contribution -->
        <div class="bg-white shadow-sm rounded-xl border border-gray-200 p-6">
          <h3 class="text-xl font-bold text-gray-900 mb-4">Contribute via PayPal</h3>
          <div v-if="request.paypal_link" class="space-y-4">
            <p class="text-sm text-gray-600">
              Click the button below to contribute financially via PayPal. Your contribution will be confirmed by the partner once received.
            </p>
            <a 
