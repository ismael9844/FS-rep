  ...
  <div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center p-4">
    <div class="max-w-2xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden">
      <div class="bg-gradient-to-r from-green-500 to-emerald-600 p-8 sm:p-12 text-center">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">Volunteer Accepted!</h1>
        <p class="text-green-100 text-sm sm:text-base">{{ message }}</p>
      </div>
      ...
      <div class="p-6 sm:p-8 lg:p-12">
        <div class="bg-gray-50 rounded-xl p-4 sm:p-6 mb-6">
          ...
          <div class="space-y-3">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center">
              <span class="font-medium text-gray-700 mb-1 sm:mb-0 sm:min-w-32 text-sm sm:text-base">Phone:</span>
              <span class="text-gray-900 text-sm sm:text-base">{{ volunteer.phone }}</span>
            </div>
            <div class="flex flex-col sm:flex-row sm:items-start">
              <span class="font-medium text-gray-700 mb-1 sm:mb-0 sm:min-w-32 text-sm sm:text-base">Skills:</span>
              <span class="text-gray-900 text-sm sm:text-base">{{ volunteer.skills }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-4 sm:p-6 rounded-lg mb-6">
          ...
          <ul class="space-y-2 text-blue-800 text-sm sm:text-base">
            <li class="flex items-start">
              ...
              <span>The volunteer has received an email with location details</span>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
              </svg>
              <span>They can now help distribute your donation</span>
            </li>
            <li class="flex items-start">
              <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
