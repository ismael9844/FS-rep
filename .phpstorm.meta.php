...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Admin\Downloads\food-donation-platform-main (1)\food-donation-platform-main\public\storage' => 'string',
...
'database.connections.mysql.port','database.connections.mysql.database','database.connections.mysql.username','database.connections.mysql.password','database.connections.mysql.charset',
'database.connections.mysql.collation','database.connections.mysql.prefix','database.connections.mysql.strict','database.connections.mysql.engine','database.connections.mysql.options',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Admin\\Downloads\\food-donation-platform-main (1)\\food-donation-platform-main\\public\\storage','logging.default','logging.deprecations.channel',
...
'services.stripe.secret','services.stripe.key','session.driver','session.lifetime','session.expire_on_close',
...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','ide-helper.filename',
...
'sanctum.csrf-cookie','distributions.index','distributions.store','distributions.show',
'distributions.update','distributions.destroy','pickups.index','pickups.store','pickups.show',
'pickups.update','pickups.destroy','volunteers.index','volunteers.store','volunteers.show',
'volunteers.update','volunteers.destroy','partners.index','partners.store','partners.show',
'partners.update','partners.destroy','photos.destroy','dashboard',
'pickups.confirm','places.my','places.index','places.create','places.destroy','places.edit',
'places.update','admin.verifications.index','admin.verifications.update','admin.volunteers.verifications','admin.volunteers.updateVerification',
'volunteer.upload-document','documents.store',
'documents.upload-form','documents.upload','admin.request-documents','profile.updatePrivacy','profile.show','profile.update',
'profile.destroy','preferences','preferences.store','preferences.update','preferences.destroy','distributions','pickups.index','volunteers',
'partners','volunteer.store','donations.show',
'pickups.destroy','donations.mine','donations.edit','donations.update',
'volunteer.needs','donations.destroy','profile.donor',
'notifications.index','volunteer.complete-profile','volunteer.save-profile','volunteer.edit',
'volunteer.update','notifications.clear','food-requests.index','food-requests.create','food-requests.store',
'food-requests.show','contributions.store','requests.index','food-requests.respond','food-requests.destroy',
'donations.map','api.donations.show','donations.map.updateLocation','profile.update-image','sponsorships.create',
'sponsorships.store','admin.sponsorships.index','admin.sponsorships.update','admin.dashboard',
'admin.users','admin.donations','admin.partners','partner.profile','volunteer.profile',
'partner.history','donations.index','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'app','emails.pickup-confirmation','emails.pickup-confirmed','emails.pickup-scheduled','vendor.mail.html.button',
...
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.Admin.Downloads.food-donation-platform-main (1).food-donation-platform-main.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'LOG_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','BROADCAST_CONNECTION','CACHE_DRIVER',
'QUEUE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','FILESYSTEM_DISK','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_APP_NAME',);
